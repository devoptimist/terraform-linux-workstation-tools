...
sudo rpm -Uhv https://packages.chef.io/files/stable/chef-workstation/${chef_workstation_version}/el/7/chef-workstation-${chef_workstation_version}-1.el6.x86_64.rpm
